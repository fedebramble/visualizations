...
function clicked(event, p) {
  ...
  const newRoot = root.each((d) => (d.target = calculateArcs(d, p)));
  ...
  // After the transition ends, set the final state.
  setTimeout(() => {
...
function clicked(event, p) {
    ...
    root.each((d) => (d.target = calculateArcs(d, p)));
